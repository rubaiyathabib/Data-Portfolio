...
Table of Contents
1. Hotel Revenue Analysis (SQL, Power BI)
2. Retail Product Sales Analysis (Python, SQL, Power BI)
3. Web Scraping USA Companies' Revenue Data (Python)
4. Monitoring and Detection of COVID-19 (IoT, ML)
5. Store E-commerce Sales Analysis (Power BI)
6. Product Sales Analysis (Tableau)
7. House Sales Analysis (Tableau)
8. Bike Sales Analysis (Excel)
